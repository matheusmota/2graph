...
/**
 * This concrete builder is used to create a database lightning fast using
...
public class Neo4jBatchInserterConcreteBuilder extends IGraphDatabase implements IGraphBuilder{
	...
	/**
	 * 
	 * @param databaseOutputDirectory requires that the output folder is empty and you have permission to write.
	 */
	...
	//from: http://stackoverflow.com/questions/3775694/deleting-folder-from-java
	...
	public void startServer() throws Exception {
	    ...
	    inserter = BatchInserters.inserter(new File(this.getSetting("db_dir")).getAbsolutePath() );
	...
	/**
	 * This is required to properly save the generated graph.
	 * Not needed to run if program closes.
	 */
	...
	public GraphNode createNode(String label, GraphElementProperties properties) throws Exception
	{
		...
		Long created = inserter.createNode(nodeProperties, DynamicLabel.label(label));
		return new GraphNode(new URI(String.valueOf(created)), label, this);
	}
	
	public GraphRelation createRelation(GraphNode startNode, String label,
			GraphNode endNode) throws Exception {
		Long created = inserter.createRelationship(Long.parseLong(startNode.getUri().toString()), Long.parseLong(endNode.getUri().toString()), DynamicRelationshipType.withName(label), null);
		return new GraphRelation(new URI(String.valueOf(created)), label, this);
	}
	...
	@Override
	public List<GraphRelation> getNodeRelations(GraphNode node)
			throws Exception {
		// TODO Auto-generated method stub
		return null;
	}
	...
	@Override
	public List<GraphRelation> getNodeInRelations(GraphNode node)
			throws Exception {
		// TODO Auto-generated method stub
		return null;
	}
	...
	@Override
	public List<GraphRelation> getNodeOutRelations(GraphNode node)
			throws Exception {
		// TODO Auto-generated method stub
		return null;
	}
	...
	@Override
	public GraphNode getStartNodeOfRelation(GraphRelation relation)
			throws Exception {
		// TODO Auto-generated method stub
		return null;
	}
	...
	@Override
	public GraphNode getEndNodeOfRelation(GraphRelation relation)
			throws Exception {
		// TODO Auto-generated method stub
		return null;
	}
	...
	@Override
	public boolean addProperty(GraphElement element,
	...
	@Override
	public boolean addProperties(GraphElement element,
			GraphElementProperties property) throws Exception {
		// TODO Auto-generated method stub
		return false;
	}
	...
	@Override
	public GraphElementProperties getProperties(GraphElement element)
			throws Exception {
		// TODO Auto-generated method stub
		return null;
	}
